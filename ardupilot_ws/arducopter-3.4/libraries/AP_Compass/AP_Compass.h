...
public:
    ...
    // Choi et al. RAID 2020 recovery (Alg.1 l.20): substitute the field of all
    // instances with the software-sensor-consistent field.
    void recovery_set_field(const Vector3f &f) {
